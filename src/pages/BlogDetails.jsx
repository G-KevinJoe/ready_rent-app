              ...
              <div className="comment__list mt-5">
                ...
                <div className="single__comment d-flex gap-3">
                  ...
                  <div className="comment__content">
                    <h6 className=" fw-bold">KEVIN JOE PRAKASH</h6>
                    <p className="section__description mb-0">14 July, 2022</p>
                    <p className="section__description">
                      Thank you for ur responce, looking forward for more adventures , for more adventures we can hook u up 
                      with out member and loyal customer LARSON SEQUEIRA , you shall enjoy spending time with that great 
                      peronality 
                    </p>
