        ...
        <Row>
          ...
          <Col lg="3" md="4" sm="6">
            <div className="mb-4">
              ...
              <p className="office__info">SFIT BORIVALI , MUMBAI , MAHARASHTRA.</p>
              <p className="office__info">Phone: 8169204667</p>

              <p className="office__info">Email: kevinjoe6j@student.sfit.ac.in</p>
          ...
          <Col lg="12">
            <div className="footer__bottom">
              <p className="section__description d-flex align-items-center justify-content-center gap-1 pt-4">
                ...
                KEVIN JOE PRAKASH. All rights reserved.
              </p>
            </div>
          </Col>
        </Row>
